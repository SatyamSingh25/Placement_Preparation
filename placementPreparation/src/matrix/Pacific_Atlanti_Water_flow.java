package matrix;
/**
 * @Common_water_between_atlantic_and_pacific_ocean
 * @DFS_on_mat_
 * @Remember_previous_value
 * (0th Row, 0th Column) -> Pacific Ocean attached
 * ((N-1) Row, (N-1) Column) -> Atlantic Ocean attached
 */
import java.util.*;
public class Pacific_Atlanti_Water_flow {
	//Main method
